...
| [FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise) | React / Node.js (TypeScript) | OpenAI API, Pinecone API, SerpAPI, Hugging Face API | Ao verificar os commits na página inicial do projeto, observei mensagens de commits comentando testes, ajustes ou adiçoes de APIs dentro do projeto |
